    ...
    return (
        <div className="col">
            <div class="d-flex justify-content-center" style = {{height:"25px"}}>
                <div class="d-flex align-items-center justify-content-center bg-dark bg-opacity-50 rounded-start-3 px-2 text-nowrap fw-bold shadow-sm h-100 justify-content-center">{name}</div>
